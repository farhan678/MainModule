...
public class PasswordActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.replace(R.id.containerView,new Changepassword_layout()).commit();
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_item_sent) {
                    Intent i=new Intent(PasswordActivity.this,SettingActivity.class);
                    startActivity(i);
                ...
                if (menuItem.getItemId() == R.id.nav_item_help) {
                    Intent i=new Intent(PasswordActivity.this,HelpActivity.class);
                    startActivity(i);
                }
