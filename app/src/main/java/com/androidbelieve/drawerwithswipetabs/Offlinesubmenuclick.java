...
public class Offlinesubmenuclick extends AppCompatActivity{
    DrawerLayout mDrawerLayout;
    NavigationView mNavigationView;
    FragmentManager mFragmentManager;
    FragmentTransaction mFragmentTransaction;
    SharedPreferences sharedpreferences,submenuvalue,localvalue;

    Menu menu;
    ImageButton logout;
    TextView username,toolbar_title;

    String sharedpreferancevalue,id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submenuvalue = getSharedPreferences("fragmentvalueif", Context.MODE_PRIVATE);
        ...
        localvalue = getSharedPreferences(sharedpreferancevalue, Context.MODE_PRIVATE);
        ...
        mFragmentTransaction.replace(R.id.containerView,new OfflinesubmenuFragment()).commit();
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_item_sent) {
                    Intent i=new Intent(Offlinesubmenuclick.this,SettingActivity.class);
                    startActivity(i);

                }

                if (menuItem.getItemId() == R.id.nav_item_inbox) {
                    Intent i=new Intent(Offlinesubmenuclick.this,HomeActivity.class);
                    startActivity(i);
                }
                if (menuItem.getItemId() == R.id.nav_item_help) {
                    Intent i=new Intent(Offlinesubmenuclick.this,HelpActivity.class);
                    startActivity(i);
                }
