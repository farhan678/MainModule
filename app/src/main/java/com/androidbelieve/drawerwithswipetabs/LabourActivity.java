...
public class LabourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Labour Listing");
...
//            toolbar_title.setText(usertype);
        ...
        mFragmentTransaction.replace(R.id.containerView,new LabourFragment()).commit();
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_item_sent) {
                    Intent i=new Intent(LabourActivity.this,SettingActivity.class);
                    startActivity(i);

                }

                if (menuItem.getItemId() == R.id.nav_item_inbox) {
                    Intent i=new Intent(LabourActivity.this,HomeActivity.class);
                    startActivity(i);
                }
                if (menuItem.getItemId() == R.id.nav_item_help) {
                    Intent i=new Intent(LabourActivity.this,HelpActivity.class);
                    startActivity(i);
                }
