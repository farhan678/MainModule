...
import com.androidbelieve.drawerwithswipetabs.LogoutFragment;
public class EmailActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.replace(R.id.containerView,new changeemail_layout()).commit();
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_item_sent) {
                    Intent i=new Intent(EmailActivity.this,SettingActivity.class);
                    startActivity(i);
                ...
                if (menuItem.getItemId() == R.id.nav_item_help) {
                    Intent i=new Intent(EmailActivity.this,HelpActivity.class);
                    startActivity(i);
                }
