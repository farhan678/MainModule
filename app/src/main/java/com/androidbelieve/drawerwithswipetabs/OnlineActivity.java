...
public class OnlineActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.replace(R.id.containerView,new SocialFragment()).commit();
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_item_sent) {
                    Intent i=new Intent(OnlineActivity.this,SettingActivity.class);
                    startActivity(i);

                }

                if (menuItem.getItemId() == R.id.nav_item_inbox) {
                    Intent i=new Intent(OnlineActivity.this,HomeActivity.class);
                    startActivity(i);
                }
                if (menuItem.getItemId() == R.id.nav_item_help) {
                    Intent i=new Intent(OnlineActivity.this,HelpActivity.class);
                    startActivity(i);
                }
